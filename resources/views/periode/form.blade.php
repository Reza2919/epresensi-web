        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ @$periode ? 'Ubah' : 'Tambah' }} Periode Tukin</h4>
                </div>
                <div class="card-body">
                    <form class="form form-vertical" method="POST" action="{{ @$periode ? route('periode.update',[$periode->id_periode]) : route('periode.store') }}">
                        @csrf
                        @if (@$periode)
                            @method('patch')
                        @endif
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="periode" class="form-control" name="periode" placeholder="Periode" value="{{ @$periode->periode }}" required>
                                </div>
                            </div>
                            <div class="col-12">
