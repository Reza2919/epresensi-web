        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Sistem Kerja</h4>
                    <div class="float-right">
                        <a href="{{ url('sistem-kerja/create') }}" class="btn btn-primary btn-sm" type="button"><i data-feather="plus"></i> Tambah Sistem Kerja</a>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function () {
        let table = $('.table').DataTable({
            ...
            order: [],
            ajax: {
                url: '{{ url("api/get-sistem-kerja/datatable") }}',
                type: 'GET',
                data: function(e){
                    e.id_satker = '{{ @$user->satkerid }}'
                }
            },
