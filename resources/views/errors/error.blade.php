...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    <img src="{{ asset('assets/app-assets/images/logo/logo-text.png') }}" alt="" style="width: 150px">
                </a>
                </a>
                <div class="misc-inner p-2 p-sm-3">
                    <div class="w-100 text-center">
                        <h2 class="mb-1">Terjadi kesalahan saat mengambil data!</h2>
                        <p class="mb-2">Oops! {{ $status.' - '.$message }}</p><a class="btn btn-primary mb-2 btn-sm-block" href="{{ url('/') }}">Dashboard</a>
                    </div>
                </div>
            </div>
            <!-- / Error page-->
