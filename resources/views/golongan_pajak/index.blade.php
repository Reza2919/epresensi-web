        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Golongan Pajak</h4>
                    <div class="float-right">
                        <a href="{{ url('golongan-pajak/create') }}" class="btn btn-primary btn-sm" type="button"><i data-feather="plus"></i> Tambah Golongan Pajak</a>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function () {
        let table = $('.table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ url("api/get-golongan-pajak/datatable") }}',
                type: 'GET',
            },
