@extends('layouts.app')
@section('title','Manual Book - Presensi KEMNAKER')
@push('css')
    <!-- BEGIN: Vendor CSS-->
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{ url('manual-book/create') }}" class="btn btn-primary btn-sm" type="button"><i data-feather="plus"></i> Tambah Data</a>
                        </div>
                    </div>
                    <div class="card-body">
